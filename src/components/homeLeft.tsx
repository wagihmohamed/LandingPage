...
export const HomeLeftBar = (): JSX.Element => {
    return (
        <div className="w-2/6 md:w-1/6 flex flex-col justify-between fixed top-0  h-full bg-gray-100" >
            <div>
                <div>
                    ...
                    <div className="px-1">
                        <div className="mt-6 bg-gray-100 space-y-6 p-4 rounded-md shadow-md">
                            ...
                            <HomeButtonCard icon={<SearchIcon className="w-9" />}>Search</HomeButtonCard>
                        </div>
                    </div>
                </div>
            </div>
